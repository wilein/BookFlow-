...
public class AdminReportController {
    ...
    public AdminResult<Map<String, Object>> list(@RequestParam(defaultValue = "1") Integer pageNo,
        ...
        return AdminResult.success(adminService.listReports(pageNo, pageSize, targetType, status));
    }

    @PostMapping("/save")
    public AdminResult<Map<String, Object>> save(@RequestBody Map<String, Object> payload) {
        return AdminResult.success("保存成功", adminService.saveReport(payload));
    }

    @PostMapping("/handle")
    public AdminResult<Map<String, Object>> handle(@RequestBody Map<String, Object> payload) {
        return AdminResult.success("处理成功", adminService.handleReport(payload));
    }
}
