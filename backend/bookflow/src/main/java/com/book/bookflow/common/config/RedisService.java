...
public class RedisService {
    ...
    public Object lGetIndex(String key, long index) {
        try {
            ...
            log.error("通过索引获取list缓存失败, key: {}", key, e);
            return null;
        }
    }
    ...
    public boolean lUpdateIndex(String key, long index, Object value) {
        try {
            ...
            log.error("修改list缓存失败, key: {}, index: {}", key, index, e);
            return false;
        }
    }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            ...
            log.error("移除list缓存失败, key: {}", key, e);
            return 0;
        }
    }
    ...
    public boolean zAdd(String key, Object value, double score) {
        try {
            ...
            log.error("添加zset缓存失败, key: {}", key, e);
            return false;
        }
    }
     ...
     * 获取分布式锁
     * @param lockKey 锁的key
     * @param requestId 请求标识（可以用UUID）
     * @param expireTime 过期时间（秒）
     * @return 是否获取成功
     */
    public boolean tryLock(String lockKey, String requestId, long expireTime) {
        try {
            String result = stringRedisTemplate.opsForValue().getAndSet(lockKey, requestId);
