        ...
        <view class="field-row">
          ...
          <radio-group class="radio-group" @change="onPermissionChange">
            <label class="radio-item" v-for="item in permissionOptions" :key="item.value">
              <radio :value="item.value" :checked="form.permission === item.value" color="#2f4f75" />
...
<style scoped>
.page { min-height: 100vh; background: #f7f9fc; }
.header { position: fixed; left: 0; right: 0; top: 0; z-index: 30; background: #ffffff; padding-left: 20rpx; padding-right: 20rpx; border-bottom: 1rpx solid #ecf1f5; display: flex; align-items: center; justify-content: space-between; box-sizing: border-box; }
...
.section { margin: 18rpx 20rpx 0; padding: 20rpx; border-radius: 22rpx; background: #ffffff; }
...
.image-item { width: 200rpx; height: 200rpx; border-radius: 16rpx; position: relative; overflow: hidden; background: #f1f5f9; }
.preview { width: 100%; height: 100%; }
.main-tag { position: absolute; left: 10rpx; top: 10rpx; padding: 4rpx 10rpx; border-radius: 999rpx; background: rgba(47, 79, 117, 0.88); color: #ffffff; font-size: 20rpx; }
...
.input, .picker-value { height: 80rpx; line-height: 80rpx; border-radius: 16rpx; background: #f3f6fb; padding: 0 20rpx; font-size: 26rpx; color: #2d3d52; box-sizing: border-box; }
.input { width: 100%; }
.picker-value { color: #5d7086; }
.scan-btn { width: 120rpx; height: 80rpx; border-radius: 16rpx; background: #edf3ff; color: #2d55c7; font-size: 24rpx; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.condition-options { display: flex; flex-wrap: wrap; gap: 12rpx; }
.condition-btn { padding: 14rpx 22rpx; border-radius: 999rpx; background: #eef2f8; color: #617489; font-size: 24rpx; }
.condition-btn.active { background: #e7efff; color: #2d55c7; font-weight: 700; }
.textarea { width: 100%; min-height: 220rpx; border-radius: 16rpx; background: #f3f6fb; padding: 20rpx; font-size: 26rpx; color: #2d3d52; box-sizing: border-box; }
...
.submit-btn { height: 84rpx; border-radius: 18rpx; background: #2f4f75; color: #ffffff; font-size: 30rpx; font-weight: 700; display: flex; align-items: center; justify-content: center; }
</style>
