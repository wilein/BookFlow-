...
function getRuntimeEnv() {
  ...
  if (miniEnv === 'trial') return 'trial';
  if (miniEnv === 'release') return 'production';
...
function resolveConfigValue(key) {
  const storageValue = uni.getStorageSync(`BOOKFLOW_${key}`);
...
export const API_BASE_URL = resolveConfigValue('API_BASE_URL');
export const IMAGE_BASE_URL = resolveConfigValue('IMAGE_BASE_URL') || API_BASE_URL;
